...
if __name__ == '__main__':
    paver = Paver()
    roads = paver.test_road_building(ROAD_WIDTH, ROAD_HEIGHT)
    ...
    car2 = Car(20,20,ROAD_WIDTH,ROAD_HEIGHT, color=(0,255,0))
    car3 = Car(50, 20, ROAD_WIDTH, ROAD_HEIGHT, color=(0,0,255))
